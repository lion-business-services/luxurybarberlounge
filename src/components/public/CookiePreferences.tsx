...
export function CookiePreferences() {
  ...
  return (
    <aside aria-label="Cookie preferences" className="fixed inset-x-4 bottom-[76px] z-[54] mx-auto max-w-3xl border border-[var(--color-ink-line)] bg-[#101010]/95 p-5 shadow-2xl sm:backdrop-blur-xl md:bottom-5">
